...
class CalendarList extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    }else if(current&&props.isSearch){
      //this.scrollToMonth(nextCurrent);
    }
  ...
  onViewableItemsChanged({viewableItems}) {
    ...
    //console.log(parseDate(visibleMonths[0]))
    this.setState({
      rows: newrows,
      currentMonth: parseDate(visibleMonths[0])
    },()=>{
      this.props.scrollChange(parseDate(visibleMonths[0]))
    });
  }
  ...
  render() {
    //console.log(this.props.pastScrollRange + this.props.futureScrollRange + 1)
    return (
      <View>
        <FlatList
          ...
          //style={[this.style.container, this.props.style]}以前的
