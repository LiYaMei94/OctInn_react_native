...
class Calendar extends Component {
    ...
    this.setState({
      ...
      if (!doNotTriggerListeners) {
        ...
        if (this.props.onMonthChange) {
          console.log(xdateToData(currMont))
    ...
    return (
      <View style={{flex: 1, alignItems: 'center'}} key={id}>
        <DayComp
          ...
          dayHeigth={this.props.dayHeigth}
        >
          {date}
        </DayComp>
      </View>
  ...
  render() {
    ...
    //,{height:this.props.calendarHeight}新增
    //console.log(this.props.calendarHeight)
    return (
      <View style={[this.style.container, this.props.style,{height:this.props.calendarHeight}]}>
        <CalendarHeader
